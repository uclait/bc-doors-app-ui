...
$(document).ready(function()
{
    ...
    $('.card-holder-plan-buttons .btn-success').on('click', function()
    {
        ...
        $(tableSelector['no-access']).dataTable().fnDestroy();
        $(tableSelector['no-access']).addClass('hide');
        $(tableSelector['no-access']).closest('.search-containers').removeClass('search-containers-spacer');

        $("#mod_assign-access input[type=text]").val('');
        ...
        function()
        {
            ...
            if ($('input:checkbox[data-id=' + data.uid + ']').length == 0)
            {
                ...
                html += "<tr>" +
                        ...
                        "<td><span class=\"icon-assigned\">&nbsp;</span>" + data.name + "</td>" +
                        "</tr>";   
            }
        }
    );
