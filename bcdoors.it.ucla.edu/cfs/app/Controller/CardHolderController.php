    ...
    public function index()
    {
        ...
        if ($continue)
        {
            ...
            if ($continue)
            {
                ...
                if ($debug) {logExecutionTime("Start Get Pending"); };
                ...
                if ($debug) {logExecutionTime("End Get Pending"); };
                ...
                if (sizeof($pending) > 0)
                {
                    ...
                    if ($debug) {logExecutionTime("Start Get Card Holder Status"); };
                    $response = $this->Http->post($api['url'], array(), $params);

                    if ($debug) {logExecutionTime("End Get Card Holder Status"); };
                    if ($this->Http->status == $this->Http->STATUS_CODE_OK)
                    {
                        $response = $this->Http->content;
                        pr($response);
            ...
            if ($continue)
            {
                ...
                //==>   DC has access to
                //=================================================================
                if ($debug) {logExecutionTime("Start Get Card Holder Allowed Access Plans"); };
                $data = $this->GrouperApi->loadGroups();
                if ($debug) {logExecutionTime("End Get Card Holder Allowed Access Plans"); };
                $merchantCNT = sizeof($merchants);
