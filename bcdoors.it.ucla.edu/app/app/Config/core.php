 ...
 */
	Configure::write('Security.cipherSeed', '768593096574535424967496836450');
...
#Cache::config('short', array('engine' => 'File', 'duration'=> '+1 hours', 'path' => CACHE));
Cache::config('short', array('engine' => 'File', 'duration'=> '+30 minutes', 'path' => CACHE));

//Cache::config('short', array('engine' => 'File', 'duration'=> '+1 day', 'path' => CACHE));
Cache::config('medium', array('engine' => 'File', 'duration'=> '+1 day', 'path' => CACHE));
Cache::config('long', array('engine' => 'File', 'duration'=> '+1 week', 'path' => CACHE));
